import { MuiBox, MuiChip, MuiIconButton, MuiInputBase, MuiPaper } from 'app/libs/mui-lib';

import styled from '@emotion/styled';

import { MuiSearch } from 'app/libs/mui-icons';
    ...
    <Container>
      <Wrapper>
        <MuiSearchPaper>
          ...
          <MuiInputBase
            sx={{ ml: 1, flex: 1 }}
            placeholder="MuiSearch the quality framework "
          />
        </MuiSearchPaper>
