...
import { MuiAppBar, MuiContainer, MuiToolbar, MuiBox, MuiButton, MuiTypography, MuiTooltip, MuiIconButton, MuiAvatar, MuiMenuItem, MuiMenu } from 'app/libs/mui-lib';
    ...
    <MuiAppBar position="fixed" className="custom-header">
      <MuiContainer maxWidth="xl">
        <MuiToolbar disableGutters>
          <MuiBox
            sx={{
              flexGrow: 1, display: { xs: 'none', md: 'flex' }, justifyContent: 'space-between', paddingX: '30px'
            }}
          >
            ...
            <MuiBox sx={{ display: 'flex' }}>
              {pages.map((page) => (
                <MuiButton
                  ...
                  onClick={handleCloseNavMenu}
                  sx={{
                    my: 1, color: 'white', fontWeight: 'bold', display: 'block', fontSize: '12px', fontFamily: 'Lato, sans-serif'
                  }}
                >
                  {page}
                </MuiButton>
